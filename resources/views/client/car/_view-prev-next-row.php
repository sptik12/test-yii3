<div class="card-page-navigation">
    ...
    <div class="prev-next-buttons">
        <?php if ($carPrevPublicId) { ?>
            <a href="<?= $preview ? '#' : $urlGenerator->generateAbsolute("client.viewCar", ["publicId" => $carPrevPublicId]) ?>" class="prev-button">
        ...
        <?php if ($carNextPublicId) { ?>
            <a href="<?= $preview ? '#' : $urlGenerator->generateAbsolute("client.viewCar", ["publicId" => $carNextPublicId]) ?>" class="next-button">
