...
<div class="add-car-page-wrapper eddit-car-page-wrapper" id="vue-edit-car">
    <div class="container"
         ...
         v-init:get-models-ajax-url="'<?= $urlGenerator->generate('dealer.getModelsForEditAjax') ?>'"
         v-init:get-vin-code-data-ajax-url="'<?= $urlGenerator->generate('dealer.getVinCodeDataAjax') ?>'"
         v-init:delete-media-ajax-url="'<?= $urlGenerator->generate('dealer.deleteMediaAjax') ?>'"
         v-init:set-media-main-ajax-url="'<?= $urlGenerator->generate('dealer.setMediaMainAjax') ?>'"
         v-init:sort-media-ajax-url="'<?= $urlGenerator->generate('dealer.sortMediaAjax') ?>'"
         v-init:upload-files-ajax-url="'<?= $urlGenerator->generate('dealer.uploadMediaAjax') ?>'"
         v-init:publish-car-ajax-url="'<?= $urlGenerator->generate('dealer.doPublishCarAjax') ?>'"
         v-init:preview-car-url="'<?= $urlGenerator->generateAbsolute('dealer.previewCar', ['publicId' => $car->publicId]) ?>'"
         v-init:update-preview-car-session-ajax-url="'<?= $urlGenerator->generate('dealer.updatePreviewCarSessionAjax') ?>'"
         v-init:restore-preview-car-session-ajax-url="'<?= $urlGenerator->generate('dealer.restorePreviewCarSessionAjax') ?>'"
         v-init:save-draft-car-url="'<?= $urlGenerator->generate('dealer.doSaveDraftCar') ?>'"
